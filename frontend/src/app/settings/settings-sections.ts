...
export const SETTINGS_SECTIONS = [
  ...
  { path: 'admin/mail', icon: 'outgoing_mail', labelKey: 'settings.mail.title', group: 'admin' },
  { path: 'admin/grafana', icon: 'monitoring', labelKey: 'settings.grafana.title', group: 'admin' },
