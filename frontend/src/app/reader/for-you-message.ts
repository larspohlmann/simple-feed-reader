 ...
 *
 * Each cause needs its own sentence: the backend giving up on the run
 * itself, or the request failing outright. Without this the run button just
 * reappears with no explanation (#308 final review, Important 1).
 *
