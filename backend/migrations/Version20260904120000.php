...
/**
 * The instance-wide outgoing-mail settings row (#834). PLATFORM-AWARE DDL for the
...
{
    private const TABLE = 'mail_server_settings';

    public function getDescription(): string
    {
        return 'Create mail_server_settings for admin-configured outgoing mail (#834)';
    }

    public function up(Schema $schema): void
    {
        $this->skipIf($schema->hasTable(self::TABLE), 'mail_server_settings already exists.');
    ...
    {
        $this->skipIf(!$schema->hasTable(self::TABLE), 'mail_server_settings does not exist.');
        $this->addSql('DROP TABLE mail_server_settings');
    }
