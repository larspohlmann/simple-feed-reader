...
/** Drop the clear-text password_hint from proxy_server_settings (#845): the admin
...
final class Version20260906120000 extends AbstractMigration
{
    ...
    {
        return 'Drop proxy_server_settings.password_hint (#845)';
    }

    public function up(Schema $schema): void
    {
        $this->assertSupportedPlatform();
        $this->addSql('ALTER TABLE proxy_server_settings DROP password_hint');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        if ($platform instanceof AbstractMySQLPlatform) {
            $this->addSql("ALTER TABLE proxy_server_settings ADD password_hint VARCHAR(8) DEFAULT '' NOT NULL");
