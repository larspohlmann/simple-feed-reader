 ...
 * through ApiExceptionListener like every other ApiException. On the login
 * path it is caught by PasskeyAuthenticator's own `catch (ApiException)`
 * block, exactly like AssertionRejectedException, and rewritten into a plain
