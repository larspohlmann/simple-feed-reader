 ...
 * to facebook.com/sharer or twitter.com/intent/tweet. A plain profile link is
 * not, because articles legitimately link to a post being written about, so that
 * shape needs a row of them before it counts.
 */
