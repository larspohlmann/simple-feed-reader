...
final readonly class AltchaService
{
    ...
    public function verify(string $payload): bool
    {
        ...
        // `number` is client-supplied. Only values the widget could plausibly
        // have found are worth hashing, and bounding it keeps the value that
        // reaches the cache key derivation predictable.
